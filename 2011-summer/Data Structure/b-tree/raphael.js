...
(function () {
    ...
    var separator = /[, ]+/,
        ...
        availableAnimAttrs = {along: "along", blur: nu, "clip-rect": "csv", cx: nu, cy: nu, fill: "colour", "fill-opacity": nu, "font-size": nu, height: nu, opacity: nu, path: "path", r: nu, rotation: "csv", rx: nu, ry: nu, scale: "csv", stroke: "colour", "stroke-opacity": nu, "stroke-width": nu, translation: "csv", width: nu, x: nu, y: nu, x1: nu, y1: nu, x2: nu, y2: nu},
        rp = "replace",
    ...
    var theLine = function (svg, x1, y1, x2, y2) {
        var el = $("line");
        svg.canvas && svg.canvas[appendChild](el);
    ...
    paperproto.line = function (x1, y1, x2, y2) {
        return theLine(this, x1 || 0, y1 || 0, x2 || 0, y2 || 0);
    };
